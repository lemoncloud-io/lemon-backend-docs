---
layout: default
title: Use lemon-core
nav_order: 5
has_children: true
permalink: /docs/lemon-core
---
...
[Go to GitHub](https://github.com/lemoncloud-io/lemon-core/tree/develop)
...
- Support Data Synchronization to `Elasticsearch` from `DynomoDB` via `DynamoStream`.
    ...
    ![](2019-11-26-23-43-47.png)

---
## Architecture

Basic MicroService Architecture with `API` + `SNS` + `SQS`.
...
See [CODE_OF_CONDUCT](code-of-conduct)
